...
status: deployed
updated: 2026-06-11
description: Run the repair-docs pipeline end-to-end — detect structural drift, then apply the mechanical fixes.
---*/

/**
 * auto-repair — the registered, runnable form of the repair-docs pipeline.
 *
